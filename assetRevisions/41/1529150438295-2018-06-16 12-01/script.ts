class PersonnelBoutonBehavior extends Sup.Behavior{
  ...
  cliqueBouton(){
    ...
    const EmbaucherOuvrier : Sup.Actor = Sup.getActor("Boutons").getChild("Rectangle").getChild("EmbaucherOuvrier");
    const EmbaucherCommercial : Sup.Actor = Sup.getActor("Boutons").getChild("Rectangle").getChild("EmbaucherCommercial");
    const EmbaucherComptable : Sup.Actor = Sup.getActor("Boutons").getChild("Rectangle").getChild("EmbaucherComptable");
    const LicencierOuvrier : Sup.Actor = Sup.getActor("Boutons").getChild("Rectangle").getChild("LicencierOuvrier");
    const LicencierCommercial : Sup.Actor = Sup.getActor("Boutons").getChild("Rectangle").getChild("LicencierCommercial");
    const LicencierComptable : Sup.Actor = Sup.getActor("Boutons").getChild("Rectangle").getChild("LicencierComptable");
